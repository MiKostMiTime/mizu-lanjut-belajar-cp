# 📚 Kumpulan Sumber Belajar CP — Gratis Semua!

> Semua sumber di halaman ini **100% gratis**. Terorganisir per kategori untuk kemudahan navigasi.

---

## 🏆 Online Judges & Problem Sets

### Wajib Dipakai

| Platform | Link | Keunggulan |
|---|---|---|
| **TLX TOKI** | [tlx.toki.id](https://tlx.toki.id/) | Platform resmi OSN Indonesia — ada Training Gate + arsip soal OSN lengkap |
| **CSES Problem Set** | [cses.fi/problemset](https://cses.fi/problemset/) | 300 soal terstruktur per topik — kualitas terbaik untuk belajar |
| **Codeforces** | [codeforces.com](https://codeforces.com/) | Contest tiap minggu, editorial lengkap, komunitas besar |
| **AtCoder** | [atcoder.jp](https://atcoder.jp/) | Soal berkualitas tinggi, terutama DP & matematika |

### Tambahan

| Platform | Link | Keunggulan |
|---|---|---|
| **SPOJ** | [spoj.com](https://www.spoj.com/) | Soal klasik CP, bagus untuk latihan |
| **HackerRank** | [hackerrank.com](https://www.hackerrank.com/) | Bagus untuk pemula, ada track per topik |
| **LeetCode** | [leetcode.com](https://leetcode.com/) | Soal interview, beberapa topik overlap dengan CP |
| **Kattis** | [open.kattis.com](https://open.kattis.com/) | ICPC-style problems |

---

## 📖 Buku & Materi Belajar (Semua Gratis)

| Judul | Link | Keterangan |
|---|---|---|
| **Competitive Programmer's Handbook** (Antti Laaksonen) | [cses.fi/book/book.pdf](https://cses.fi/book/book.pdf) | ⭐ **Wajib baca!** Buku CP terbaik, komprehensif, gratis |
| **USACO Guide** | [usaco.guide](https://usaco.guide/) | Roadmap terstruktur dari Bronze sampai Platinum, ada soal per topik |
| **CP-Algorithms** | [cp-algorithms.com](https://cp-algorithms.com/) | Referensi algoritma lengkap dengan penjelasan & kode |
| **Pemrograman Kompetitif Dasar (TOKI)** | [Tersedia di TLX](https://tlx.toki.id/) | Modul bahasa Indonesia — bagus untuk pemula |
| **Introduction to Algorithms (CLRS)** | Tersedia di library | Buku algoritma klasik — untuk referensi mendalam |
| **The Art of Problem Solving (AoPS)** | [artofproblemsolving.com](https://artofproblemsolving.com/) | Matematika kompetitif |

---

## 🎬 YouTube Channels

### Channel Utama (Wajib Subscribe)

| Channel | Fokus | Keunggulan |
|---|---|---|
...
| Channel | Fokus |
|---|---|
| **Algorithms Live!** | CP advanced topics |
| **Petr Mitrichev** | Tips dari peringkat #1 dunia |
| **tourist** | Solutions review dari GOAT |
| **SecondThread** | CP editorial & upsolving |
| **Rachit Jain** | CP untuk pemula sampai menengah |
...
| Sumber | Topik | Link |
|---|---|---|
| CSES | Dynamic Programming (19 soal) | [cses.fi/problemset/list/](https://cses.fi/problemset/list/) |
| AtCoder DP Contest | 26 soal DP klasik | [atcoder.jp/contests/dp](https://atcoder.jp/contests/dp) |
...
## 🇮🇩 Komunitas CP Indonesia

| Komunitas | Platform | Keterangan |
|---|---|---|
| **CP Indonesia** | Telegram: `@cpindonesia` | Diskusi soal, sharing editorial |
| **TOKI — Tim Olimpiade Komputer Indonesia** | [toki.or.id](https://toki.or.id/) | Organisasi resmi OSN Informatika |
| **TLX Forum** | [tlx.toki.id/forums](https://tlx.toki.id/forums) | Forum diskusi soal OSN |
| **Codeforces Indonesia** | Codeforces group | Cari di Codeforces "Indonesia" |
| **r/compprog** | Reddit | Komunitas international |

---

## 💻 Sumber Belajar Neovim / Vim

| Sumber | Link | Keterangan |
|---|---|---|
| **vimtutor** | Ketik `vimtutor` di terminal | Tutorial built-in, mulai di sini! |
| **OpenVim** | [openvim.com](https://openvim.com) | Latihan vim interaktif di browser |
| **Vim Cheat Sheet** | [vim.rtorr.com](https://vim.rtorr.com/) | Referensi keybinding |
| **ThePrimeagen** | [YouTube](https://www.youtube.com/c/ThePrimeagen) | Tutorial Neovim + produktivitas |
| **Fireship** | [YouTube — Vim in 100s](https://www.youtube.com/watch?v=-txKSRn0qeA) | Intro singkat 2 menit |

---

## 🔧 Tools CP yang Berguna

| Tool | Link | Kegunaan |
|---|---|---|
| **Competitive Companion** | [Chrome](https://chrome.google.com/webstore/detail/competitive-companion/cjnmckjndlpiamhfimnnjmnckgghkjbl) / [Firefox](https://addons.mozilla.org/en-US/firefox/addon/competitive-companion/) | Auto-download test cases ke editor |
| **CF-Predictor** | [Chrome Extension](https://chrome.google.com/webstore/detail/cf-predictor/ocfloejijfhhkkdmheodbaanephbnfhn) | Prediksi rating change di Codeforces |
| **Codeforces Visualizer** | [cfviz.netlify.app](https://cfviz.netlify.app/) | Visualisasi statistik Codeforces |
| **A2OJ Ladder** | Closed, tapi ada mirrors | Ladder soal per rating |
| **Stopstalk** | [stopstalk.com](https://www.stopstalk.com/) | Track progress + teman |

---

*📚 Semua sumber di atas gratis. Fokus konsistensi, bukan jumlah sumber!*
